...
class TriviaQuestion {
    ...
    public boolean checkAnswer(String answer) {
        if(this.type == TRUEFALSE) {
            return answer.charAt(0) == this.answer.charAt(0);
        } else {
    ...
    public boolean equals(Object o) {
        ...
        return value == that.value && type == that.type && Objects.equals(question, that.question) && Objects.equals(answer, that.answer);
    }
...
class TriviaData {
    ...
    public void addQuestion(String q, String a, int v, int t) {
        this.data.add(new TriviaQuestion(q, a, v, t));
    }
