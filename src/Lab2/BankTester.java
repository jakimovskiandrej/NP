...
class Account {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(balance, account.balance) == 0 && id == account.id && Objects.equals(name, account.name);
    }
...
abstract class Transaction {
    ...
    @Override
    public int hashCode() {
        int result = Long.hashCode(fromId);
        result = 31 * result + Long.hashCode(toId);
...
class FlatAmountProvisionTransaction extends Transaction {
    ...
    @Override
    public int hashCode() {
        return Double.hashCode(flatAmount);
    }
}
...
class Bank {
    ...
    public boolean makeTransaction(Transaction t) {
        Account fromAccount = findAccount(t.getFromId());
        Account toAccount = findAccount(t.getToId());
        if(fromAccount == null && toAccount == null || fromAccount.getBalance() < t.getAmount()) {
            return false;
        }
        double provision = calculateProvision(t);
        ...
        if(fromAccount.getBalance() >= totalDeduction) {
            ...
            totalTransferredAmount+=t.getAmount();
    ...
    private double calculateProvision(Transaction t) {
        if(t instanceof FlatPercentProvisionTransaction) {
            return t.getAmount() * ((FlatPercentProvisionTransaction) t).getPercent() / 100.0;
        } else if (t instanceof FlatAmountProvisionTransaction) {
            return ((FlatAmountProvisionTransaction) t).getAmount();
        }
        return 0;
    }
