...
class IntegerArray {
    ...
    public IntegerArray concat(IntegerArray ia) {
        int result[] = new int[this.numbers.length + ia.numbers.length];
        for (int i = 0; i < this.numbers.length; i++) {
            result[i] = this.numbers[i];
        }
        for (int i = 0; i < ia.numbers.length; i++) {
            result[i + this.numbers.length] = ia.numbers[i];
        }
...
public class IntegerArrayTest {
    ...
    static void testReading(ByteArrayInputStream in) {
    ...
    // static void printStatistic(IntegerArray ia) {
    //     System.out.println(ia.statistic(ia));
    // }

    // static void printInverse(IntegerArray ia) {
    //     System.out.println(ia.inverseNumbers(ia));
    // }
