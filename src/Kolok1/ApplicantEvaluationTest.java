...
class EvaluatorBuilder implements Evaluator {
    ...
    public boolean evaluate(Applicant applicant) throws InvalidEvaluation {
        ...
        else if(type==TYPE.MORE_EXPERIENCE) {
            return applicant.getEmploymentYears() >= 10;
        }
        else if(type==TYPE.MORE_CREDIT_SCORE) {
            return applicant.getCreditScore() >= 500;
        }
        else if(type==TYPE.NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE) {
        ...
        else if(type==TYPE.MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE) {
        ...
        else if(type==TYPE.NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE) {
