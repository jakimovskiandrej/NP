...
class BookCollection {
    ...
    public void printByCategory(String category) {
        books.stream().filter(b -> b.category.equals(category)).sorted(Comparator.comparing(Book::getPrice).thenComparing(Book::getTitle)).forEach(b -> System.out.println(b.toString()));
    }
